...
public class RPSLSpock {
    ...
    /**
     * Validates the user's pick
     * @param pick user input (rock, paper, scissors, lizard, or spock)
     * @return Whether or not user input is valid (boolean)
     */
    ...
    /**
     * Generates a pick for the computer player
